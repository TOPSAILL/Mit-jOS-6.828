...
.LM11:
	...
	.cfi_def_cfa_offset 32
	call	memset
	.stabn	68,0,35,.LM12-.LFBB2
.LM12:
	call	cons_init
	.stabn	68,0,44,.LM13-.LFBB2
.LM13:
	popl	%eax
	.cfi_def_cfa_offset 28
	popl	%edx
...
.LM25:
	...
	.cfi_def_cfa_offset 32
	call	vcprintf
	.stabn	68,0,82,.LM26-.LFBB3
.LM26:
	movl	$.LC6, (%esp)
	call	cprintf
	.stabn	68,0,83,.LM27-.LFBB3
.LM27:
	addl	$16, %esp
	.cfi_def_cfa_offset 16
	jmp	.L11
...
.LFB3:
	...
	subl	$8, %esp
	.cfi_def_cfa_offset 16
	.stabn	68,0,97,.LM29-.LFBB4
.LM29:
	leal	28(%esp), %ebx
	.stabn	68,0,98,.LM30-.LFBB4
.LM30:
	subl	$4, %esp
	.cfi_def_cfa_offset 20
	pushl	24(%esp)
...
.LM31:
	...
	.cfi_def_cfa_offset 32
	call	vcprintf
	.stabn	68,0,100,.LM32-.LFBB4
.LM32:
	movl	$.LC6, (%esp)
	call	cprintf
	.stabn	68,0,102,.LM33-.LFBB4
.LM33:
	addl	$24, %esp
	.cfi_def_cfa_offset 8
	popl	%ebx
